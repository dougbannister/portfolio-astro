...
## User research
The accumulation of feedback from customers and the sales team as well as routine [user sessions](/articles/how-to-user-sessions/) were gathered and helped to structure and prioritise further areas of research. In conjunction with this, session recording with Hotjar provided further evidence and insight into quick wins as well as the underlying issues that needed to be designed.
