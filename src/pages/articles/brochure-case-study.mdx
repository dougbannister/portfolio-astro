...
![the data led design and testing process](/img/Brochure-process.png)
...
![original view of the brochure request page](/img/Brochure-context.png)
...
![an example of the proposed grid layout and checkbox](/img/Brochure-observation.png)
...
![initial concepts showing a grid layout for brochures](/img/Brochure-initial-ideas.png)
...
![test results showed a 25% increase in brochure requests](/img/Brochure-testing.png)
...
![view of the redesigned brochure request page](/img/Brochure-results.png)
...
![the redesigned thank you page of the brochure request process](/img/Brochure-results-2.png)