...
An export of our current database showed that the typical user will live in and around London and is less likely to have English as a first language. Additionally, ADSL broadband is chosen over fibre broadband.
...
Even though there is a fairly clean and simple layout, the 33% Drop off (39% for mobile) is therefor likely to occur on the 'Welcome' page due to lack of trust and visitors not knowing the true value when engaging with the flow and the form.
...
There appeared to be a lot of general confusing.
