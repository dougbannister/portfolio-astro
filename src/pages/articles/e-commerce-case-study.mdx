...
![demographic data for ](/img/HT-2.png)
...
![graph of visitor drop off for each step in order flow](/img/HT-graph.png)
...
![click heatmapping examples from Crazyegg](/img/HT-Results.png)
...
![example of the redesigned order flow](/img/HT-Results-2.png)
...
![a view of the progress path design](/img/HT-Results-3.png)
