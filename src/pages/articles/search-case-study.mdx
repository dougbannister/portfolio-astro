...
[User testing](/articles/how-to-user-sessions/) and competitor analysis inspired initial ideas. I suggested that the search bar is displayed prominently over the hero image as it a. saves above the fold space and b. is more prominent on the page for the visitor. This functionality would not work very well on mobile devices so, instead of being in the hero, users can click on a ‘search’ button to open the search dropdown.
