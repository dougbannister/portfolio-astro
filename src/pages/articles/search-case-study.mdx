...
When some websites like Google Flights, Airbnb and Skyscanner are getting many unique visits a month, it made sense for me to check their search too. Visitors build up familiarity with these systems over time and may expect similar solutions and behaviour elsewhere. It also gives a picture of emerging trends and tech being used.
