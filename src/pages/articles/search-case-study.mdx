...
Visitors build up familiarity with these systems over time (Jakob's Law) and may expect similar solutions / models and behaviour elsewhere. Therefore, it made sense for me to check leading websites like Google Flights, Airbnb and Skyscanner. It also gives a picture of emerging trends and tech being used.

![spreadsheet showing a comparison of search bar features](/img/search-bar-grid.png)
...
![spreadsheet of search results features](/img/search-results-grid.png)

With an initial assessment of the information architecture and structure, the Titan results cards appear cluttered. 

![search results structure](/img/search-architecture.png)
...
![concept for asearch bar on desktop and mobile](/img/search-concept.png)
...
![design concept for a sticky search filters](/img/search-results-concept.png)

## Going forward
As part of a website rebuild, the search and search results were eventually redesigned and developed.

![redesigned search results page vs old](/img/search-final.png)
...
![Figma prototyping and flows](/img/search-big-vision-concept-1.png)
![Figma interactive prototype](/img/search-big-vision-concept-2.png)
...
![travel trip search wizard](/img/wizard-concept.png)
