...
_(source: bradfrost.com)_

Brad suggested the idea of a [global design system](https://bradfrost.com/blog/post/whats-next-for-a-global-design-system/), one that could prevent duplicated efforts and allow teams to focus on more meaningful work, like improving accessibility and overall quality. That idea really hit home for me.
...
P.S. Like Brad, I think a [Global Design System](https://bradfrost.com/blog/post/a-global-design-system/) is the way forward too :D and it seems that [Open UI](https://open-ui.org/get-involved/) is beginning that work.