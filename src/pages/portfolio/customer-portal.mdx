...
__Overview:__ One of my first projects at Travelopia was revamping the World Challenge customer portal. As the sole designer, I reported directly to product managers, owning the design process from research to high-fidelity UI. My task was to improve the portal’s information architecture and simplify its navigation, mapping the current features into a more user-friendly experience and aligning it with user journeys. The scope was limited to improving the existing features, with no plans for introducing new ones.
...
The portal was used by various types of users, such as students, parents, and school leaders, each with different goals and access needs.
