...
description: 'One of my first projects at Travelopia was revamping the World Challenge customer portal.'
pubDate: 'Aug 02 2023'
...
Design an easy-to-use customer portal for World Challenge, a company providing life-changing, experiential travel opportunities for 15-18 year olds. The portal needed to be intuitive for users like students, parents, and expedition leaders, allowing them to manage bookings and update pre-departure information.

__Time frame:__ 2 weeks

__My role:__ As the sole designer, I reported directly to product managers, owning the design process from research to high-fidelity UI.

## Overview

One of my first projects at Travelopia was revamping the World Challenge customer portal. The portal was used by various types of users, such as students, parents, and school leaders, each with different goals and access needs. My task was to improve the portal’s information architecture and simplify its navigation, aligning it with user journeys. The scope was limited to improving the existing features, with no plans for introducing new ones.

My deliverables included a complete workflow of customer journeys, refined information architecture, wireframes, and a high-fidelity UI that aligned with World Challenge’s brand guidelines. The goal was to map the current features into a more user-friendly experience without adding new features just yet.

## Discovery

To kick off the project, I created a 'knowledge board' - a tool I find incredibly helpful for gathering and organising information during the discovery phase. This board included:
...
So, I created simple personas to obviously help me and my team align and empathise with the users.
