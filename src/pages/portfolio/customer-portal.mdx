...
As the designer at Travelopia for World Challenge, I reported directly to product managers, owning the design process from research to prototyping.

<Button href="https://www.figma.com/proto/Qru88JZN5G2DjzJAL65ATR/Docs?page-id=107%3A1241&node-id=1416-36226&node-type=frame&viewport=16099%2C-8473%2C0.16&t=YCW8gGttJIBz0nxN-8&scaling=min-zoom&content-scaling=fixed&starting-point-node-id=1416%3A36226&disable-default-keyboard-nav=1&hide-ui=1" target="_blank">View the prototype</Button>
